    ...
    <footer className="bg-zinc-900 text-zinc-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">Wasteland Mods</h3>
            <p className="mb-4">
              Premium DayZ mods for server owners looking to enhance their player experience.
            </p>
            <div className="flex space-x-4">
              <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-white">
              ...
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/mods" className="hover:text-white transition-colors">
                  Browse Mods
                </Link>
              </li>
              <li>
