  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link 
                href="/about" 
                className="bg-transparent border-2 border-white hover:bg-white/10 text-white px-6 py-3 rounded-md text-lg font-medium transition-colors"
              >
                Learn More
              </Link>
            </div>
      ...
      <section className="py-16 bg-zinc-900">
        <div className="container mx-auto px-4">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold mb-4">Featured Mods</h2>
      ...
      <section className="py-16 bg-zinc-950">
        <div className="container mx-auto px-4">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold mb-4">Why Choose Our Mods?</h2>
            <p className="text-zinc-300 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-800 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-2">Quality Tested</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-green-700">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Enhance Your DayZ Server?</h2>
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Browse our collection of premium mods and take your server to the next level today.
          </p>
          <Link 
            href="/mods" 
            className="bg-white text-green-700 hover:bg-white/90 px-6 py-3 rounded-md text-lg font-medium transition-colors"
          >
            Get Started
          </Link>
        </div>
